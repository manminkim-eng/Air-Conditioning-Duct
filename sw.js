/* ═══════════════════════════════════════════════════
   ...
   공조덕트 — 공조 덕트 규격 산정 시스템  MANMIN Ver-5.0
   Service Worker — 오프라인 캐시 + 버전 업데이트
   ENGINEER KIM MANMIN

   v5.0.0 (2026-09-03)
   ───────────────────────────────────────────────────
   [변경] 문서(HTML)까지 Cache-first 로 처리하던 v2.0 구조를 고쳤다.
   ...
   [변경] 종전 캐시명 'duct-v2.0' 은 접두어가 같아 PREFIX 필터로 지워지지만,
...
const CACHE  = 'duct-v5.0.4';   /* 2026-09-03 v5.0 디자인 통일 */
